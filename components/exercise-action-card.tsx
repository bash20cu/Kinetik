...
export function ExerciseActionCard({
  ...
  return (
    <div
      className={cn(
        "flex h-full flex-col overflow-hidden rounded-[1.45rem] border border-border/70 bg-card/95 p-3 shadow-[0_26px_80px_-48px_rgba(15,23,42,0.6)] backdrop-blur md:rounded-[2rem] md:p-5",
        className
      )}
    >
      ...
      <div className="mt-auto space-y-2.5 pt-4 md:space-y-4 md:pt-6">
        ...
        <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_220px] md:gap-3">
          <Button type="button" size="lg" className="min-h-10 rounded-[1rem] text-base md:min-h-12 md:rounded-[1.35rem]" onClick={onSeriesDone}>
          ...
          <Button
            type="button"
            variant="outline"
            className="min-h-10 rounded-[1rem] text-base md:min-h-12 md:rounded-[1.35rem]"
